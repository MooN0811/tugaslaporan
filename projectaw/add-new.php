...
$sql = "INSERT INTO `datapenelitian`(`SHIP`, `CRUISE`, `SAMPLENUM`, `DEVICE`, `SUM`, `DATE`, `DEPTH`, `LENGTH`, `LOCATION`, `SEDTYPE`, `STORAGE`, `REMARK`, `VOL`, `LATITUDE`, `LONGITUDE`, `LOKASIRAK`, `FOTOSPESIMEN`, `NOKLASIFIKASILAPORAN`, `PETALINTASAN`, `STATUSANALISA`) VALUES (NULL,'$SHIP','$CRUISE','$SAMPLE_NUM','$DEVICE','$SUM','$DATE','$DEPTH','$LENGTH','$LOCATION','$SED_TYPE','$STORAGE','$REMARK','$VOL','$LATITUDE','$LONGITUDE','$LOKASI_RAK','$FOTO_SPESIMEN','$NO_KLASIFIKASI_LAPORAN','$PETA_LINTASAN','$STATUS_ANALISA')";
...
<div class="container">
  ...
  <form action="add-new.php" method="POST">
    ...
    <div class="form-row">
      ...
      <a href="#" class="btn btn-cancel"><i class="fas fa-times"></i> Cancel</a>
    </div>
  </form>
</div>
